          ...
          return (  
            <div className="todo">
              <button
                ...
                className="checkbox"
                style={{ backgroundColor: todo.status ? "rgb(78, 242, 108)" : "white" }}
              ></button>
              <p>{todo.name}</p>
              <button className="editDeleteButton" onClick={() => handleWithEditButtonClick(todo)}>
                <AiOutlineEdit  size={20} color={"#64697b"}></AiOutlineEdit>
              </button>
              <button className="editDeleteButton" onClick={() => deleteTodo(todo)}>
